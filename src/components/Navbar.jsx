...
function Navbar() {
  ...
  return (
    <>
      <nav className="navbar hidden fixed top-0 z-40 md:block bg-gray-950 h-16 text-white w-full ">
      ...
      <nav className="navbar md:hidden fixed top-0 z-20 bg-gray-950 h-16 text-white w-full ">
